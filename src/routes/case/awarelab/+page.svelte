<script lang="ts">
  import { caseAwarelabKo, caseAwarelabEn, caseKumoKo, caseKumoEn } from '$lib/data/cases';
  import { blogPostsKo, blogPostsEn } from '$lib/data/blog';
  import { locale } from '$lib/i18n/runes.svelte';
  import Glass from '$lib/components/Glass.svelte';
  import Nav from '$lib/components/Nav.svelte';

  import ssHome from '$lib/assets/projects/screenshots/awarelab/home.png';
  import ssAdminHome from '$lib/assets/projects/screenshots/awarelab/admin-home.png';
  import ssAdminMember from '$lib/assets/projects/screenshots/awarelab/admin-member-detail.png';
  import ssI18n from '$lib/assets/projects/screenshots/awarelab/i18n.png';
  import ssPortfolio from '$lib/assets/projects/screenshots/awarelab/portfolio.png';
  import ssSub from '$lib/assets/projects/screenshots/awarelab/subscription.png';

  const screenshots = [
    { src: ssHome, alt: 'Awarelab Home' },
    { src: ssPortfolio, alt: 'Portfolio Page' },
    { src: ssSub, alt: 'Subscription Page' },
    { src: ssI18n, alt: 'i18n / Multilingual' },
    { src: ssAdminHome, alt: 'Admin Dashboard' },
    { src: ssAdminMember, alt: 'Admin Member Detail' },
  ];

  const D = $derived(locale.current === 'ko' ? caseAwarelabKo : caseAwarelabEn);
...
<div class="case-page">
  ...
  {#if D.context}
    <section class="context-section">
      <div class="section-label">&textcircled;2 CONTEXT</div>
      <Glass>
        <div class="context-grid">
          {#each D.context as c, i}
            <div class="context-cell" class:border-right={(i % 3) !== 2} class:border-bottom={i < D.context.length - 3}>
              <div class="context-key">{c.k}</div>
              <div class="context-val">{c.v}</div>
            </div>
          {/each}
        </div>
      </Glass>
...
<style>
  ...
  .context-cell.border-right {
    border-right: 1px solid var(--line);
  }
  .context-cell.border-bottom {
  ...
  @media (max-width: 760px) {
    ...
    .context-cell.border-right { border-right: none; }
    .context-cell.border-bottom { border-bottom: 1px solid var(--line); }
